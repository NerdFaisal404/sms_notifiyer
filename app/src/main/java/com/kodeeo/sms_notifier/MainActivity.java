...
import com.kodeeo.sms_notifier.fragment.FragmentCompose;
import com.kodeeo.sms_notifier.fragment.FragmentContacts;
import com.kodeeo.sms_notifier.fragment.FragmentHome;
import com.kodeeo.sms_notifier.util.ContactsManager;
import com.kodeeo.sms_notifier.util.ImageOptionsBuilder;
...
public class MainActivity extends ActionBarActivity {
    ...
    private void rateApp() {
        final Uri uri = Uri.parse("market://details?id=ArC+builder+Group" + getApplicationContext().getPackageName());
